...
## Content (from CV + LinkedIn, data-driven in `src/data/experience.ts`, newest-first)
Emilia (Founding Engineer — product + technical foundation) · SoftServe (R&D Engineer,
AI) · NOUSWARE (AI Engineering Lead — 57→80%, ~40% cost) · Ivanti (Integration Engineer
— 18+ workflows, ~35% triage) · Ivanti (Support L2 — 80+ incidents, MTTR ~28%) · Floes
Connecting (Founder, IoT). Each: role, company, period, location, 2 concise highlights.
All localized EN/ES.
